# 🛡️ **Visión del Proyecto: LUCES-CÁMARA-UDEA**

LUCES-CÁMARA-UDEA es un proyecto académico desarrollado por estudiantes de Ingeniería Industrial de la Universidad de Antioquia, cuyo propósito es diseñar e implementar un sistema de gestión para un cine universitario, accesible desde consola y construido en lenguaje Python. Este sistema busca ofrecer una experiencia organizada, eficiente y amigable para los usuarios de la comunidad universitaria, permitiendo la administración de reservas, funciones, facturación y reportes administrativos.
...
- Consulta de cartelera y disponibilidad de funciones del fin de semana.
- Generación de facturas según tipo de usuario.
...
El equipo de desarrollo asume con responsabilidad el cumplimiento de los entregables, la calidad del código, la claridad de la documentación y la disposición para la mejora continua. Cada integrante participa activamente en la planificación, codificación, revisión y sustentación del proyecto, respetando los acuerdos establecidos en las actas de entendimiento, colaboración y responsabilidad.
